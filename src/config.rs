...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ColosseumComputer".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["assistenza.bioweb.agency"];
pub const RS_PUB_KEY: &str = "GORZwzcKhAyyIkMnzWvY9oFg7Z2wIItkfBUtQL5SAXE=";
