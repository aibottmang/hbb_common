...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("93.51.43.12".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["93.51.43.12"];
pub const RS_PUB_KEY: &str = "DUdup1I22OgH7HkCqXjbIgvtW+wVztxaDnQVmPbcWCo=";
